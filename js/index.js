 ...
 */
 ...
 $(function(){
    ...
    var $wrap = $('.wrap'),
        ...
        enemyCollection = new Array(),
        bulletCollection = new Array(),
        collisionTimer1 = 0,
        width = $wrap.width(),
        height = $wrap.height();
        ...
        function startGame(event){
            ...
            GameMananger.switchStartStatus();
            GameMananger.overed = false;
            initScene();
            $(document).on('mousemove',planeMove);
            shot();
            createEnemy();
            collisionTimer1 =  setInterval(GameMananger.collisionCheckGobal,50);
        }
